...
<%-- 									<td>${event.eventstatus}</td> --%>
									<td>
										<FORM METHOD="post"
											...
											<input type="submit" value="修改" class="btn-changed">
...
<!-- 											style="margin-bottom: 0px;"> -->
<!-- 											<input type="submit" value="退團" class="btn-changed"> -->
...
<!-- 										</FORM> -->
	...
	<script>
		$("div.content_row div.content_left div").eq(3).find("a").addClass("now_choice");
	</script>
