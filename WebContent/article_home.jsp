...
<%@ include file="pages/page1.file" %> 
	...
	<c:forEach var="art" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
		...
		<tr>
			...
			<td>${art.ACCTID}</td>
			<td>
			<a href='<%=request.getContextPath()%>/article/ArticleServlet?action=getOne_For_Display&AID=${art.AID}'>${art.ANAME}</a>
...
<div class="addnew">
	<a href='<%=request.getContextPath()%>/article/articleAdd.jsp'>Create an Article</a>
</div>
