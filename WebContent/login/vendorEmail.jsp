	...
	<div class="login-wrap">
		...
		<div class="login-html">
			...
			<input id="tab-1" type="radio" name="tab" class="sign-in" checked><label
				for="tab-1" class="tab">註冊成功</label>

			<div class="login-form">

				<div class="sign-in-htm">
					<form class="login"
						ACTION="<%=request.getContextPath()%>/vendor/VendorForgetPassword?action=forgetPassword"
						...
						<div class="result_zone">
							...
							<c:if test="${sendEmail}">
								<a href="<%=request.getContextPath()%>/vendor/VendorServlet?action=vendorEmail&vendorid=${vendorid}" id="send_btn">點擊發送驗證信</a>
							</c:if>
						<div class="hr"></div>
						<div class="foot-lnk">
							<a href="<%=request.getContextPath()%>/login/vendorLogin.jsp">返回登入/註冊頁面</a>
						</div>
					</form>
				</div>
