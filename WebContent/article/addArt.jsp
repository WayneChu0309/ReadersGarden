...
<table id="table-1">
	<tr><td>
		 <h3>新增文章 - addArt.jsp</h3></td><td>
		 <h4><a href="<%=request.getContextPath()%>/select_article.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="ANAME" size="45" 
			 value="<%= (art==null)? "DDD" : art.getANAME()%>" /></td>
	</tr>
