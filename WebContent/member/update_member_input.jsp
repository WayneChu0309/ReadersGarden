...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath()%>/member/selectMember.jsp"><img src="images/back1.gif" width="100" height="32" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	<tr>
		...
		<td><input type="TEXT" name="mname" size="45" 
			 value="<%= (memberVO==null)? "李容號" : memberVO.getName()%>" /></td>
	</tr>
	<tr>
		<td>信箱:</td>
		<td><input type="TEXT" name="memail" size="45"
			 value="<%= (memberVO==null)? "bnre657@gmail.com" : memberVO.getEmail()%>" /></td>
	</tr>
	<tr>
		<td>生日:</td>
		<td><input type="TEXT" name="birthday" size="45"
		    value="<%= (memberVO==null)? "1998-08-02" : memberVO.getBirthday()%>" /></td>
	</tr>
	<tr>
		<td>電話:</td>
		<td><input type="TEXT" name="phoneNumber" size="45"
			 value="<%= (memberVO==null)? "0978345672" : memberVO.getPhoneNumber()%>" /></td>
	</tr>
	<tr>
		<td>地址:</td>
		<td><input type="TEXT" name="address" size="45"
			 value="<%= (memberVO==null)? "高雄市鹽埕區新樂街28號" : memberVO.getAddress()%>" /></td>
	</tr>
	
		<tr>
		<td>身分證字號:</td>
		<td><input type="TEXT" name="ID" size="45"
			 value="<%= (memberVO==null)? "D123456780" : memberVO.getID()%>" /></td>
	</tr>
	
		<tr>
		<td>密碼:</td>
		<td><input type="TEXT" name="password" size="45"
			 value="<%= (memberVO==null)? "abc5566" : memberVO.getPassword()%>" /></td>
	</tr>
	
	<tr>
		<td>會員狀態:</td>
		<td><input type="TEXT" name="status" size="45"
			 value="<%= (memberVO==null)? "停用" : memberVO.getStatus()%>" /></td>
	</tr>
...
<input type="hidden" name="number" value="<%=memberVO.getNumber()%>">
