...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="<%=request.getContextPath()%>/member/selectMember.jsp"><img src="images/tomcat.png" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<table>
	...
	<tr>
		...
		<td><input type="TEXT" name="phoneNumber" size="45"
			 value="<%= (memberVO==null)? "" : memberVO.getPhoneNumber()%>" /></td>
	</tr>
	<tr>
		<td>地址:</td>
	...
	<tr>
		...
		<td><input type="TEXT" name="status" size="45"
			 value="<%= (memberVO==null)? "" : memberVO.getStatus()%>" /></td>
	</tr>
