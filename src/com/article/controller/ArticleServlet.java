...
public class ArticleServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		if ("getOne_For_Display".equals(action)) { // 來自article_home.jsp的請求
			...
			try {
				...
				if (!errorMsgs.isEmpty()) {
					RequestDispatcher failureView = req
							.getRequestDispatcher("/article_home.jsp");
				...
				String url = "/newArticle/articleShow.jsp";
...
//				art.setAPD(APD);
				...
				String url = "/article/articleListAll.jsp";
